...
describe('GildedRose', () => {
  describe('updateQuality', () => {
    ...
    test('should handle Backstage passes', () => {
    ...
    test('should handle Conjured items', () => {
      const conjuredItem = new Item('Conjured', 5, 10);
    ...
    test('should handle regular items', () => {
      const regularItem = new Item('Some Item', 5, 10);
